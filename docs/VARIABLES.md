...
- **`state.mapRenderedTransit`** - Last transit payload pushed into the persistent map sources
- **`state.lastMapFeatureStateSignature`** - Signature for the last applied map feature-state visibility update
