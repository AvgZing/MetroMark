...
// world quadtree. The list is ordered by global relevance: the world's biggest,
// most-used transit cities come first so they get their base layer (and then
// complete headway/stops data) before the less-visited cities. Mainland China
// is excluded because Transitland has no data there; a future non-Transitland
// source will add it. This file is maintenance data only; add or reorder freely.
...
module.exports = [
  ...
  { name: "Columbus", lat: 39.96, lon: -83 },
  ...
  { name: "Worcester", lat: 42.26, lon: -71.8 },
  ...
  { name: "McAllen", lat: 26.2, lon: -98.23 },
  { name: "Columbia", lat: 34, lon: -81.03 },
  ...
  { name: "Greenville", lat: 34.85, lon: -82.4 },
  ...
  { name: "Gold Coast", lat: -28.02, lon: 153.4 },
  ...
  { name: "Caracas", lat: 10.48, lon: -66.9 },
  ...
  { name: "Barranquilla", lat: 10.97, lon: -74.8 },
  { name: "Maracaibo", lat: 10.64, lon: -71.61 },
  { name: "Karachi", lat: 24.86, lon: 67 },
  ...
  { name: "Yaoundé", lat: 3.85, lon: 11.5 },
  ...
  { name: "Ibadan", lat: 7.38, lon: 3.9 },
  { name: "Kano", lat: 12, lon: 8.52 },
];
